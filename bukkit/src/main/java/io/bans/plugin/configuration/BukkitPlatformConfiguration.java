package io.bans.plugin.configuration;
...
public class BukkitPlatformConfiguration implements PlatformConfiguration {
     ...
     */
    public BukkitPlatformConfiguration(Platform platform, File configFile) {
