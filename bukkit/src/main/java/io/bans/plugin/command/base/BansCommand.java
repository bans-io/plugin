package io.bans.plugin.command.base;

import io.bans.platform.command.PlatformCommand;
import io.bans.plugin.platform.BukkitPlatform;
import io.bans.plugin.command.base.sub.DebugCommand;
import io.bans.plugin.command.base.sub.SetupCommand;
...
public class BansCommand implements CommandExecutor {
     ...
     */
    public BansCommand(BukkitPlatform platform) {
